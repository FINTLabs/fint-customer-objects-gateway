...
@Component
public class DeleteClientHandler extends FintCustomerObjectEventHandler<ClientEvent, Client> {
    private final ClientService clientService;

    public DeleteClientHandler(EventTopicService eventTopicService,
                               EventConsumerFactoryService consumer,
                               OrganisationService organisationService,
                               EventProducerFactory eventProducerFactory,
                               ClientService clientService) {
        super(eventTopicService, consumer, organisationService, eventProducerFactory, Client.class, "delete");
