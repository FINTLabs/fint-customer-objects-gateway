...
public class AdapterRequestBroker extends FintCustomerObjectRequestBroker<AdapterEvent, Adapter> {
    public AdapterRequestBroker(OrganisationService organisationService, Collection<FintCustomerObjectHandler<Adapter, AdapterEvent>> fintCustomerObjectHandlers) {
